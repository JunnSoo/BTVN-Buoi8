...
public class ListSinhVien {
	...
	public void taoDuLieuGia() {
        ...
        danhSachSinhVien.add(new SinhVien("Nguyen Van A", "SV001", 8.5, 7.5, 9.0));
        danhSachSinhVien.add(new SinhVien("Tran Thi B", "SV002", 9.5, 9.0, 8.5));
        danhSachSinhVien.add(new SinhVien("Le Van C", "SV003", 6.0, 5.5, 4.0));
        danhSachSinhVien.add(new SinhVien("Pham Thi D", "SV004", 7.5, 8.0, 7.0));
        danhSachSinhVien.add(new SinhVien("Hoang Van E", "SV005", 4.5, 3.0, 5.0));
        danhSachSinhVien.add(new SinhVien("Vu Thi F", "SV006", 9.0, 9.5, 8.5));
        danhSachSinhVien.add(new SinhVien("Do Van G", "SV007", 6.5, 7.0, 6.0));
	}
